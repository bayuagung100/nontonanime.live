...
$genre = potong($url3, '<div class=ongoinglist>', '<div id=sct_sidebar class=fr>');
$genre =  str_ireplace('<div class=clear></div></div></div>', '', $genre);
$going =$genre;
	...
	<div class="col-md-8">
		...
		<div class="terbaru">
			...
			<div class="episodes row">
				...
				$data = explode('<div class=ongoinginfo>', $going);
				$count = count($data);
				$count = $count-1;
